...
from .views import LoginView, RegisterView, PermissionManageView, UserStatusManageView, ChangePasswordView, ChangeUserProflieView, SearchUserView, GetUserProflieView
